...
def ex4_3_theory():
    ...
    with tab1:
        ...
        st.latex(r"""
        \begin{cases}
        -\,T_1\sin(10^\circ)+T_2\cos(80^\circ)=0\\
    ...
    with tab2:
        ...
        st.latex(r"""
        \begin{cases}
        -\,T_1\cos(10^\circ)+T_2\sin(10^\circ)=0\\
        \phantom{-}\,T_1\sin(10^\circ)+T_2\cos(10^\circ)=3150
        \end{cases}
        """)
        st.markdown(
            "Da 1ª equação: "
    ...
    with tab3: 
        ...
        st.latex(r"T_1 \cos(10^\circ) - T_2 \cos(80^\circ) = 3150")
        ...
        fig = figure_vectors(
            [(T2_vec, "T₂", "C0"), (T1_vec, "T₁", "C2"), (W_vec, "W", "C3")],
            title="Diagrama — Exercicio 3"
        )
...
""")
    ...
    fig = figure_vectors(
        [(T2_vec, "T₂", "C0"), (T1_vec, "T₁", "C2"), (W_vec, "P", "C3")],
        title="Diagrama — Exercicio 3"
    )
    st.pyplot(fig, use_container_width=True)
